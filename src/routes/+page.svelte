...
<!-- Hero -->
<div class="mt-12 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
	<!-- Grid -->
	<div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
		<div>
			<h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Dare <span class="text-blue-600">Attractive Offers</span> in your startup</h1>
			<p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Expertly crafted pay-as-you-go system, designed for many kinds of startups. Database, stripe and even web components included.</p>

			<!-- Buttons -->
			<div class="mt-7 grid gap-3 w-full sm:inline-flex">
				<a href="offers/yearly" class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
					Try the demo
					<svg class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
				</a>
				<a href='https://cvlink.in/cv/64a2bf631657ebcdbc710180' class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
					Contact me
				</a>
			</div>
			<!-- End Buttons -->
			...
			<div class="mt-1">
				<!-- Toast -->
				<div class="ml-0 sm:ml-40 md:ml-10 lg:ml-40 max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700" role="alert">
					<div class="flex p-4">
						...
						<div class="ms-3">
							<p class="text-sm text-gray-700 dark:text-gray-400">
								I'm exploring opportunities for an accomplished developer specializing in Node.js and/or Java? Feel free to reach out — I am actively seeking engaging projects and collaborations. Let's connect!
							</p>
						</div>
					</div>
				</div>
		...
		<div class="relative ms-4">
			<img class="w-full rounded-md" src="joyStartup.webp" alt="Your startup is a rocket">
